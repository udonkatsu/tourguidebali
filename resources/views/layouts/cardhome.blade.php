<div class="min-h-screen bg-gradient-to-tr flex justify-center items-center md:-mt-60 bg-[#f8fafc]">
  <div class="md:px-4 md:grid md:grid-cols-3 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
    ...
    <div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500 md:mb-10">
