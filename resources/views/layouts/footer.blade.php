<footer class="bg-white" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
        <img class="h-20" src="https://cdn2.vectorstock.com/i/1000x1000/37/31/bali-simple-hand-drawn-logo-indonesia-tourism-vector-26043731.jpg" alt="Company name">
        <p class="text-lx font-semibold leading-6 text-gray-600">Bali TourGuide</p>
        <p class="text-sm leading-6 text-gray-600">Bali TourGuide adalah perusahan tour di Bali dengan harga terjangkau dan terpercaya berserta berlegalitas hukum.</p>
