...
<div class="w-full h-screen"
    ...
    <div class="w-full h-screen flex flex-col items-center justify-between bg-gray-400 bg-opacity-70 py-8">
        <div class="flex-1 flex flex-col items-center justify-center">
            <div
                class="bg-white bg-opacity-10 px-4 py-2 rounded-xl flex items-center justify-center text-cyan-100 space-x-2 lg:space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 lg:h-8 xl:h-10 w-6 lg:w-8 xl:w-10" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4">
                    </path>
                </svg>
                <span class="text-xl lg:text-2xl xl:text-3xl font-bold">Bali Wishful Trips</span>
            </div>
            <h1
            ...
            <div class="flex flex-col items-center space-y-4 mt-24">
                <p class="text-gray-300 uppercase text-sm">Segera Hadir</p>
            </div>
        </div>
            ...
            <ul class="flex items-center space-x-4">
                <li>
                    <a href="#" title="Facebook">
                        <svg class="w-6 lg:w-8 h-6 lg:h-8 hover:scale-110 transition duration-300" fill="currentColor"
                ...
                <li>
                    <a href="#" title="Twitter">
                        <svg class="w-6 lg:w-8 h-6 lg:h-8 hover:scale-110 transition duration-300"
